...
export default function Services() {
    ...
    <div className="container" data-aos="fade-up">
      ...
      <div className="section-title">
        ...
        <p>Our platform&apos; packages are meticulously designed to support the MVP project, ensuring a comprehensive and efficient development process. The services included in our packages are as follows:</p>
      </div>
      ...
      <div className="row">
        ...
        <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
          <div className="icon-box">
            ...
            <p>We design and develop bespoke WordPress, Drupal themes that align with your MVP&apos; branding and functional requirements, ensuring a unique and optimized web presence.</p>
          </div>
        </div>
        ...
        <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
          <div className="icon-box">
            ...
            <p>To extend the functionality of your MVP&apos; WordPress site, we create custom plugins. Whether you need to add specific features, integrate third-party services, or improve operational efficiency, our custom plugin development service is geared towards enhancing your platform&apos; capabilities.</p>
          </div>
        </div>
